// The following program is to Edit Lead in "leaftaps" site
package week2.day2;
...
// Finding department name element, description element by name and entering values using sendkeys
...
// Finding submitButton using class name and click on it.
		...
		submitButton.click();
// Find editButton using xpath and click on it
...
// Add some texts to important note
